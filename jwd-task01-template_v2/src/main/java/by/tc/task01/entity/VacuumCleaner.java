...
public class VacuumCleaner extends Appliance {
	...
	public int hashCode() {
		...
		result = prime * result
				+ Objects.hash(bagType, cleaningWidth, filterType, motorSpeedRegulation, powerConsuption, wandType);
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(bagType, other.bagType) && cleaningWidth == other.cleaningWidth
				...
				&& powerConsuption == other.powerConsuption && Objects.equals(wandType, other.wandType);
	}

	@Override
	public String toString() {
		return getClass().getName() + super.toString() + " [powerConsuption=" + powerConsuption + ", filterType="
				+ filterType + ", bagType=" + bagType + ", wandType=" + wandType + ", motorSpeedRegulation="
